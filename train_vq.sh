...
python -m torch.distributed.launch --standalone \
    ...
    --config=/workspace/cogview_dev/xutd/xu/bsq-vit/configs/tokenizer/imagenet_256x256_gaussianvit_kl2.5e-6_target_stylegan_f8_fp16.yaml \
    --output-dir=./logs/imagenet_256x256_gaussianvit_kl2.5e-6_target_stylegan_f8_fp16
