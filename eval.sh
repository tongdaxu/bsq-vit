...
python -m torch.distributed.launch --standalone \
    ...
    --evaluate \
    --config=/workspace/cogview_dev/xutd/xu/bsq-vit/configs/tokenizer/imagenet_256x256_ta_t_16_g_4_stylegan_f8_fp16_lr_2e-7.yaml \
    --output-dir=./logs/imagenet_256x256_ta_t_16_g_4_stylegan_f8_fp16_lr_2e-7/ \
    --mode=mle \
    --kl=16 \
    --dim=4
