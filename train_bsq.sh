...
python -m torch.distributed.launch --standalone \
    ...
    --config=/workspace/cogview_dev/xutd/xu/bsq-vit/configs/tokenizer/imagenet_256x256_bsqvit_b64g64_stylegan_f8_fp16_lr_2e-7.yaml \
    --output-dir=./logs/imagenet_256x256_bsqvit_b64g64_stylegan_f8_fp16_lr_2e-7
